...
public class SQLQueries {
    ...
    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN =
            "SELECT CONSUMER_KEY, AUTHZ_USER, ACCESS_TOKEN_TABLE.TENANT_ID, "
                    ...
                    + "SUBJECT_IDENTIFIER FROM (SELECT * FROM IDN_OAUTH2_ACCESS_TOKEN WHERE ACCESS_TOKEN=? AND TOKEN_STATE='ACTIVE') AS IDN_OAUTH2_ACCESS_TOKEN "
                    +"JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID) AS ACCESS_TOKEN_TABLE"
...
//            "ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID";
    ...
    public static final String GET_ACTIVE_DETAILS_FOR_CONSUMER_KEY = "SELECT IDN_OAUTH2_ACCESS_TOKEN.AUTHZ_USER, " +
            ...
            " IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_SCOPE  FROM IDN_OAUTH2_ACCESS_TOKEN INNER JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE" +
