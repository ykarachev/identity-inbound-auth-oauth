...
public class InvalidOAuthClientExceptionTest {
    ...
    public void testConstructorWithMessage(){
        InvalidOAuthClientException e = new InvalidOAuthClientException(MESSAGE);
    ...
    public void testConstructorWithMessageAndThrowable(){
        ...
        InvalidOAuthClientException e = new InvalidOAuthClientException(MESSAGE, throwable);
        Assert.assertEquals(e.getMessage(), MESSAGE);
