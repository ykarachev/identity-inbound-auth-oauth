...
/**
 * Holds the services supplied by OSGI
 */
public class ServiceHolder {
    ...
    public KeyProviderService getKeyProviderService() {
        if (keyProviderService == null) {
            keyProviderService = (KeyProviderService) PrivilegedCarbonContext.getThreadLocalCarbonContext()
                    .getOSGiService(KeyProviderService.class, null);
        }
