...
public class DCUnregisterRequestFactory extends HttpIdentityRequestFactory{

    private static Log log = LogFactory.getLog(DCUnregisterRequestFactory.class);
    ...
    public boolean canHandle(HttpServletRequest request, HttpServletResponse response) throws
        ...
        if(log.isDebugEnabled()){
            log.debug("canExceptionHandle "+ canHandle +" by DCUnregisterRequestFactory.");
        }
        return canHandle;
    }
    ...
    public IdentityRequest.IdentityRequestBuilder create(HttpServletRequest request, HttpServletResponse response)
        ...
        DCUnregisterRequest.DCRUnregisterRequestBuilder unregisterRequestBuilder =
                new DCUnregisterRequest.DCRUnregisterRequestBuilder();
    ...
    public void create(IdentityRequest.IdentityRequestBuilder builder, HttpServletRequest request,
        ...
        DCUnregisterRequest.DCRUnregisterRequestBuilder unregisterRequestBuilder = (DCUnregisterRequest.DCRUnregisterRequestBuilder)builder ;
