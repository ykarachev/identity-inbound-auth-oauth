...
public class OIDCAuthzRequestFactory<T extends OIDCAuthzRequest.OIDCAuthzRequestBuilder> extends AuthzRequestFactory<T> {
    ...
    @Override
    public void create(T oidcAuthzRequestBuilder,
